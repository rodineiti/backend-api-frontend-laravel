  ...
  <div class="container-fluid container-fixed-lg">
    ...
    <div class="panel panel-transparent">
      <div class="panel-heading">
        <div class="panel-title">Editar Conta a Pagar
        </div>
        <div class="pull-right">
          <div class="col-xs-12">
            <a href="{{route('bill_pays.index')}}" class="btn btn-primary btn-cons">Contas a Pagar
            </a>
          </div>
        </div>
      ...
      <div class="panel-body">
        <form id="form-bill_pay" class="p-t-15" role="form" action="{{ route('bill_pays.update', ['id' => $bill_pay->id]) }}" method="post">
	        {{method_field('PUT')}}
			{{ csrf_field() }}
      <div class="row">
          <div class="col-sm-6">
          ...
          <div class="col-sm-6">
            <div class="form-group form-group-default">
             ...
             <input type="date" class="form-control" name="date_launch" id="date_launch" value="{{$bill_pay->date_launch}}" required>
            </div>
        ...
        <div class="row">
          <div class="col-sm-6">
            <div class="form-group form-group-default">
              <label>Nome</label>
              <input type="text" name="name" id="name" placeholder="Nome" class="form-control" value="{{$bill_pay->name}}" required>
            </div>
            @if ($errors->has('name'))
        ...
        <div class="row">
          <div class="col-sm-6">
            <div class="form-group form-group-default">
              <label>Valor</label>
              <input type="text" name="value" id="value" class="form-control" placeholder="0.000,00" value="{{$bill_pay->value}}" required>
            </div>
            @if ($errors->has('value'))
