  ...
  <div class="container-fluid container-fixed-lg">
    ...
    <div class="panel panel-transparent">
      <div class="panel-heading">
        <div class="panel-title">Cadastro de Categoria
        </div>
      ...
      <div class="panel-body">
        <form id="form-category" class="p-t-15" role="form" action="{{ route('categories.store') }}" method="post">
	        {{ csrf_field() }}
	      <div class="row">
	        <div class="col-sm-6">
	          <div class="form-group form-group-default">
	            <label>Nome</label>
	            <input type="text" name="name" id="name" placeholder="Categoria" class="form-control" required>
	          </div>
	          @if ($errors->has('name'))
